...
Normality testing — Jarque-Bera test, skewness/kurtosis, Q-Q plot against a normal distribution
Market regression — OLS regression of UNH returns against S&P 500 and NASDAQ, correlation, R², alpha, beta
Random walk testing — Augmented Dickey-Fuller test on log prices vs. returns, followed by Monte Carlo simulation (100 paths, 1-year horizon) of future price paths
CAPM vs. OLS beta comparison — CAPM-predicted beta against empirically estimated OLS beta, with Jensen's Alpha tested for statistical significance
